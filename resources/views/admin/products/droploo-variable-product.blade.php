                ...
                <div class="col">
                    <div class="card radius-10 mb-0">
                        <div class="card-body">
                            ...
                            <form action="{{ url('/dropshipping-variable-products/store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="row g-2 align-items-center mb-3">
                                                    ...
                                                    <!-- Wholesale Price -->
                                                    <div class="col-md-2">
                                                        <input type="text" name="wholesale_price_variable[]" class="form-control" placeholder="Wholesale Price" readonly disabled>
                                                    </div>
